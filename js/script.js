...
/* ==========================================================================
   6. INTERACTIVE CONFESSIONS SECTION
   ========================================================================== */
function initInteractiveSection() {
  ...
  if (!buttons.length || !confessionText) return;

  const confessions = {
    smile: "I blame your smile for making this website longer than it needed to be.",
    vibe: "There is something about your vibe... I haven't figured it out yet.",
    confidence: "The way you carry yourself is... let's just say, it doesn't go unnoticed. ✨",
    style: "You somehow manage to make simple outfits look unfairly good.",
    expressions: "Those tiny facial expressions you make when you are thinking? Highly charming. 🌸",
    presence: "You don't have to do much to be noticed."
  };
  ...
  buttons.forEach(btn => {
    btn.addEventListener('click', (e) => {
      ...
      const text = confessions[key];

      // Remove active states
      buttons.forEach(b => b.classList.remove('active'));
      btn.classList.add('active');

      // Animate confession container
      if (confessionBox) {
        confessionBox.style.transform = 'scale(0.98)';
        confessionBox.style.boxShadow = '0 0 20px rgba(142, 59, 86, 0.4)';
        setTimeout(() => {
          confessionBox.style.transform = 'scale(1)';
        }, 150);
      }

      // Typing effect
      typeText(confessionText, text);

      // Trigger small rose petal burst at the click location
      if (particleEngine) {
